...
from backend.API.extensions import mail, scheduler  

from backend.API.auth import auth_bp
from backend.API.system import system_bp
from backend.API.reliability import reliability_bp
from backend.API.condition_monitoring import cm_bp
from backend.API.rcm import rcm_bp
from backend.API.data_manager import data_manager_bp
from backend.API.rul import rul_bp
from backend.API.tasks import tasks_bp
from backend.API.etl import etl_bp
from backend.API.files import files_bp
from backend.API.dashboard import dashboard_bp
from backend.API.misc import misc_bp
